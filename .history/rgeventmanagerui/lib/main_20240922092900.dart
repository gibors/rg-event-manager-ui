...
import 'package:rg_event_management_ui/modules/graduation.dart';
    ...
    return SizedBox(
      ...
      child: Column(
        ...
        children: [ 
          ...
          SizedBox(height: 30),
          Row(children: [
            Text('Eventos', style: Theme.of(context).textTheme.bodyMedium),
            SizedBox(width: 20),
            Text('Total de eventos: ${snapshot.data!.length}', style: Theme.of(context).textTheme.headline1),
          ],),
          SizedBox(height: 20),
        Expanded(
          child: PlutoGrid(
