                      ...
                      Expanded(
                        ...
                        rows: snapshot.data!
                            .map((e) => PlutoRow(cells: {
                                  ...
                                  'additional_cost': PlutoCell(value: e.additionalQuantity),
                                  'additional_paid': PlutoCell(
                                      value: e.payments.isNotEmpty && e.payments.where( (element) => element.paymentDetail == 'adicional').isNotEmpty
                                          ? e.payments.where((element) => element.paymentDetail == 'adicional').toList()
                                              .map((e) => e.amount)
                                              .reduce((value, element) =>
                                                  value + element)
                                          : 0),
                                  'additional_remaining': PlutoCell(
                                      value: e.additionalQuantity -
                                          (e.payments.isNotEmpty
                                              ? e.payments
                                                  .map((e) => e.amount)
                                                  .reduce((value, element) =>
