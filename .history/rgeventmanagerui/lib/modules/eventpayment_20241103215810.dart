                        ...
                        child: Column(children: [
                          Row(
                            children: [
                              ...
                              Expanded(
                                child: Text(
                                    'Total pagado: \$${isGraduation ? (selectedStudent.payments.isNotEmpty ? selectedStudent.payments.map((e) => e.amount).reduce((a, b) => a + b): 0) : (paymentsHistory.isNotEmpty ? paymentsHistory.map((e) => e.amount).reduce((a, b) => a + b) : 0)}',
                                    style: TextStyle(
                              ...
                              Expanded(
                                child: Text(
                                    'Total a pagar: \$${isGraduation ? selectedStudent.totalCost : (selectedEvent.totalCost) }',
                                    style: TextStyle(
                                        fontSize: 14.0, color: Colors.black)),
                              ),
                              SizedBox(width: 20),
