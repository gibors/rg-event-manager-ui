  ...
  addPayment() {
    ...
    if( totalAmount > selectedStudent!.totalCost){
      Flushbar(
        flushbarPosition: FlushbarPosition.TOP,
        title: 'Error',
        message: 'El pago excede el costo total del paquete/platillo, solo puedes cobrar  \$${selectedStudent!.totalCost - totalPaid} y despues agregar pagos adicionales u otro servicio',
