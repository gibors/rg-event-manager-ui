...
class _AddProviderPage extends State<AddProviderPage> {
  ...
  saveSupplier() {
    mapFormToObject();
    // EventService().saveSupplier(token, selectedSupplier!).then((value) {
    //   if (value) {
    //     ScaffoldMessenger.of(context)
    //         .showSnackBar(SnackBar(content: Text('Proveedor guardado')));
    //   } else {
    //     ScaffoldMessenger.of(context)
    //         .showSnackBar(SnackBar(content: Text('Error al guardar proveedor')));
    //   }
    // });
  }
