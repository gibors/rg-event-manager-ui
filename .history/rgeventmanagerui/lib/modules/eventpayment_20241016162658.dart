  ...
  addPayment() {
    ...
    if( totalPaid > selectedStudent!.totalCost){
      Flushbar(
        flushbarPosition: FlushbarPosition.TOP,
        title: 'Error',
        message: 'El pago excede el costo total del paquete/platillo, solo puedes cobrar ${totalPaid - selectedStudent!.totalCost} y despues agregar a adicionales o otro servicio',
