...
class _EventPaymentPageState extends State<EventPaymentPage> {
  ...
  String _requireSouvenir = RequireSouvenir.NO.toString();
  String _requirePreParty = RequirePreParty.NO.toString();
                      ...
                      Visibility(
                        ...
                        child: Column(
                          children: [
                            ...
                            Row(
                              children: [
                                Visibility(visible: isGraduation,
                                  child: Expanded(
                                    child: TextFormField(
                            ...
                            Row(
                              children: <Widget>[
                                 Text('Requiere souvenir: '),
                                 SizedBox(width: 10),
       RadioListTile<RequireSouvenir>(
          title: const Text('Si'),
          value: RequireSouvenir.YES,
          groupValue: _requireSouvenir,
          onChanged: (RequireSouvenir? value) {
            setState(() {
              _character = value;
            });
          },
                              ...
                              Text('Historial de pagos',
                                  style: TextStyle(
                                      ...
                                      Visibility(
                                        ...
                                        child: Expanded(child: Text('PAGADO', style: TextStyle(fontSize: 20.0, color: Colors.green))
                                        ),
                                      ),
                                      SizedBox(width: 20),
                                      Expanded(child: Text('Total pagado: \$${paymentsHistory.isNotEmpty ? paymentsHistory.map((e) => e.amount).reduce((a, b) => a + b) : 0}', 
                                      style: TextStyle(fontSize: 14.0, color: Colors.black)),
                                      ),
                                      SizedBox(width: 20),
                                      Expanded(child: Text('Total a pagar: \$${selectedStudent != null ? selectedStudent.totalCost : 0}', 
                                      style: TextStyle(fontSize: 14.0, color: Colors.black)),
                                      ),
                                      SizedBox(width: 20),
                                      Expanded( flex: 5,
                          ...
                          Column(children: [
                            Row(
                              children: [
                                ...
                                SizedBox(width: 20),
                                Visibility( visible:  selectedStudent != null && selectedStudent.folio.isNotEmpty,
