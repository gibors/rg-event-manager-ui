...
class _EventPaymentPageState extends State<EventPaymentPage> {
  ...
  addPayment() {
    ...
    var format = NumberFormat('###.00', 'es_MX').currencySymbol;
    if( totalPaid > selectedStudent!.totalCost){
      Flushbar(
        flushbarPosition: FlushbarPosition.TOP,
        title: 'Error',
        message: 'El pago excede el costo total del paquete/platillo, solo puedes cobrar  ${format.format(totalPaid - selectedStudent!.totalCost)} y despues agregar pagos adicionales u otro servicio',
