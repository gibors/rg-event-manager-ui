  ...
  addPayment() {
    ...
    if( totalPaid > selectedStudent!.totalCost){
      Flushbar(
        flushbarPosition: FlushbarPosition.TOP,
        title: 'Error',
        message: 'El pago excede el costo total del paquete/platillo, solo puedes cobrar  ${format.format((totalPaid - selectedStudent!.totalCost).toString())} y despues agregar pagos adicionales u otro servicio',
