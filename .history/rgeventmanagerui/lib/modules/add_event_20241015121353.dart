  ...
  void saveEvent() {
    ...
    if (double.tryParse(eventCost.text)! > 0 &&
      ...
      Flushbar(
        ...
        title: 'Error',
        message:
            'No se puede tener costo por platillo y paquetes al mismo tiempo',
          ...
          child: Form(
            ...
            child: Column(
              children: [
                ...
                Visibility(
                  visible:
                      selectedEventType != null && selectedEventType!.id == 1,
                  child: Row(
                    children: [
                      Expanded(
                        child: TextFormField(
                ...
                Visibility(
                  visible:
                      selectedEventType != null && selectedEventType!.id == 2,
                  child: Row(
                    children: [
                      Expanded(
                        child: TextFormField(
