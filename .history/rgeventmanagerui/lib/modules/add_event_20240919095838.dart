            ...
            children: [
              ...
              Expanded(
                child: TextFormField(
                  ...
                  inputFormatters: [
                    FilteringTextInputFormatter.allow(RegExp(r'^\w+@\w+\.\w+'))
                  ],
              ...
              children: [
                ...
                Row(
                  ...
                  style: ButtonStyle(
                    ...
                    fixedSize: MaterialStateProperty.all<Size>(Size(150, 80)),
                  ),
                  onPressed: () {
                    if (_formKey != null &&
                ...
                style: ButtonStyle(
                  ...
                  foregroundColor:
                      MaterialStateProperty.all<Color>(Colors.white),
                  fixedSize: MaterialStateProperty.all<Size>(Size(150, 100)),
                ),
                ),
                SizedBox(width: 16.0),  
                Visibility(child: ElevatedButton( 
                  onPressed: () { 
                    ...
                    child: Text('Administrar Graduados'),
                    style: ButtonStyle(
                      backgroundColor: MaterialStateProperty.all<Color>(
                          Color.fromRGBO(250, 50, 100, 0.8)),
                      foregroundColor:
