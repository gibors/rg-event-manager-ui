                        ...
                        child: Column(children: [
                          Row(
                            children: [
                              ...
                              Expanded(
                                child: Text(
                                    'Total pagado: \$${isGraduation ? (selectedStudent.payments.isNotEmpty ? paymentsHistory.map((e) => e.amount).reduce((a, b) => a + b): 0) : (paymentsHistory.isNotEmpty ? paymentsHistory.map((e) => e.amount).reduce((a, b) => a + b) : 0)}',
                                    style: TextStyle(
