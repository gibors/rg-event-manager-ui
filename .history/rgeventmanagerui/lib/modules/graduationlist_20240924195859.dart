        ...
        Expanded(
          ...
          rows: snapshot.data!.map((e) => PlutoRow( 
                  cells: {
                    ...
                    'paid': PlutoCell(value: e.payments.map((e) => e.amount).reduce((value, element) => value + element)),
                    'remaining': PlutoCell(value: e.totalCost - e.payments.map((e) => e.amount).reduce((value, element) => value + element)),
                    'student_status': PlutoCell(value: e.totalCost - e.payments.map((e) => e.amount).reduce((value, element) => value + element) >= e.totalCost ? 'Pagado' : 'Pendiente de pago'),
