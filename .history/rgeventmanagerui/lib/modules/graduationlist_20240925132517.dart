        ...
        Expanded(
          ...
          rows: snapshot.data!.map((e) => PlutoRow( 
                  cells: {
                    ...
                    'student_status': PlutoCell(value: e.totalCost - (e.payments.length > 0 ? e.payments.map((e) => e.amount).reduce((value, element) => value + element): 0 ) >= e.totalCost ? 'Pagado' : 'Pendiente de pago'),
