                            ...
                            children: [
                              Text('Historial de pagos',
                                  style: TextStyle(
                                      ...
                                      SizedBox(width: 20),
                                      Expanded(child: Text('Total pagado: \$${paymentsHistory.isNotEmpty ? paymentsHistory.map((e) => e.amount).reduce((a, b) => a + b) : 0}', style: TextStyle(fontSize: 20.0, color: Colors.blue)),
                                      ),
                            ],
                          ),
                          SizedBox(height: 20),
