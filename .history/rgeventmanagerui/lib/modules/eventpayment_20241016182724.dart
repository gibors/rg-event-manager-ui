                              ...
                              Text('Historial de pagos',
                                  style: TextStyle(
                                      ...
                                      Visibility(
                                        ...
                                        child: Expanded(child: Text('PAGADO', style: TextStyle(fontSize: 14.0, color: Colors.green))
                                        ),
                                      ),
                                      SizedBox(width: 20),
                                      Expanded(child: Text('Total pagado: \$${paymentsHistory.isNotEmpty ? paymentsHistory.map((e) => e.amount).reduce((a, b) => a + b) : 0}', style: TextStyle(fontSize: 14.0, color: Colors.black)),
                                      ),
                                      SizedBox(width: 20),
                                      Expanded(child: Text('Total a pagar: \$${selectedStudent != null ? selectedStudent.totalCost : 0}', style: TextStyle(fontSize: 14.0, color: Colors.black)),
                                      ),
                            ],
                          ),
                          SizedBox(height: 20),
