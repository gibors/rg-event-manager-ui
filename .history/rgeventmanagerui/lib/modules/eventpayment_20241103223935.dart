                        ...
                        child: Column(children: [
                          Row(
                            children: [
                              ...
                              SizedBox(width: 25),
                              Expanded(
                                child: Text('Restante: \$${isGraduation ? ( selectedStudent != null && selectedStudent.payments.isNotEmpty ? selectedStudent!.totalCost - selectedStudent.payments.map((e) => e.amount).reduce((a, b) => a + b) : 0) 
